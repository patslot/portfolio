  ...
  render() {
    return (
      <div id="modal" className="block spacer m-top-xl">
        ...
        <p>
          Use Bootstrapís JavaScript modal plugin to add dialogs to your site
          for lightboxes, user notifications, or completely custom content. You
          also need to add the modal-adv-1 CLASS to your parent modal DIV
          element.
        </p>
        ...
        <div className="bd-example">
          ...
          <Modal
            className="modal fade modal-adv-1"
