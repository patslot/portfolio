                ...
                <div className="row">
                    <div className="col col-1 position-relative">
                        ...
                        <div className="spacer p-top-lg">
                            <p className="p-large w-75">My name is Pat Kwok. <br /> I’m a front-end developer and heres is my portfolio. Have a look.</p>
                        </div>
                    </div>
                            ...
                            <div className="align-self-start w-100">
                                <div className="img object-fit">
                                    <div className="object-fit-cover">
                                        <img src="assets/img/myphoto.jpg" className="img-fluid" alt="Pat Kwok" />
                                    </div>
                                </div>
                            </div>
